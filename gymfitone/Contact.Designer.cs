namespace GymFitnessCenter
{
    partial class Contact
    {
        ...
        private void InitializeComponent()
        {
            ...
            label3.Location = new Point(1257, 15);
            ...
            label2.Font = new Font("Constantia", 18F, FontStyle.Bold, GraphicsUnit.Point);
            label2.ForeColor = Color.Crimson;
            label2.Location = new Point(388, 105);
            ...
            label5.Font = new Font("Calibri", 18F, FontStyle.Bold, GraphicsUnit.Point);
            label5.ForeColor = Color.Maroon;
            label5.Location = new Point(522, 239);
            label5.Margin = new Padding(6, 0, 6, 0);
            label5.Name = "label5";
            label5.Size = new Size(334, 59);
            label5.TabIndex = 47;
            label5.Text = "Abhishek Peddi";
            ...
            label6.Location = new Point(331, 239);
            label6.Margin = new Padding(6, 0, 6, 0);
            label6.Name = "label6";
            label6.Size = new Size(175, 59);
            label6.TabIndex = 48;
            label6.Text = "NAME :";
            // 
            // label4
            ...
            label4.Location = new Point(249, 343);
            label4.Margin = new Padding(6, 0, 6, 0);
            label4.Name = "label4";
            label4.Size = new Size(259, 59);
            label4.TabIndex = 50;
            ...
            label7.Location = new Point(522, 343);
            label7.Margin = new Padding(6, 0, 6, 0);
            label7.Name = "label7";
            label7.Size = new Size(346, 59);
            label7.TabIndex = 49;
            label7.Text = "+1 614 787 0766";
            // 
            // label8
            // 
            ...
            label8.Location = new Point(349, 437);
            label8.Margin = new Padding(6, 0, 6, 0);
            label8.Name = "label8";
            label8.Size = new Size(159, 59);
            label8.TabIndex = 52;
            label8.Text = "Email :";
            // 
            // label9
            ...
            label9.Location = new Point(522, 437);
            label9.Margin = new Padding(6, 0, 6, 0);
            label9.Name = "label9";
            label9.Size = new Size(618, 59);
            label9.TabIndex = 51;
            label9.Text = "peddiabhishek55@gmail.com";
            // 
            // label10
            // 
            ...
            label10.Location = new Point(297, 546);
            label10.Margin = new Padding(6, 0, 6, 0);
            label10.Name = "label10";
            label10.Size = new Size(208, 59);
            label10.TabIndex = 54;
            ...
            label11.Location = new Point(522, 546);
            label11.Margin = new Padding(6, 0, 6, 0);
            label11.Name = "label11";
            label11.Size = new Size(370, 59);
            label11.TabIndex = 53;
            label11.Text = "3 blackbreey way";
            // 
            // label12
            // 
            label12.AutoSize = true;
            label12.Font = new Font("Calibri", 18F, FontStyle.Bold, GraphicsUnit.Point);
            label12.ForeColor = Color.Maroon;
            label12.Location = new Point(522, 606);
            label12.Margin = new Padding(6, 0, 6, 0);
            label12.Name = "label12";
            label12.Size = new Size(0, 59);
            label12.TabIndex = 55;
            // 
            // button3
            // 
            ...
            button3.Location = new Point(429, 740);
            ...
            pictureBox1.Location = new Point(115, 19);
